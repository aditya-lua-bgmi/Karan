...
pcall(function()
    ...
    if not _G._BYPASS_MSG_SHOWN then
        ...
        ShowSuccessMessage("@NxTLvLKaran", "✓ COMPLETE BYPASS ACTIVE\n✓ 100% Telemetry Killed\n✓ 8-LAYER ANTI-CHEAT BYPASSED\n✓ Play Safe | Enjoy")
    end
end)
...
local function ESPTick()
    ...
    if not crowded and HUD and currentPawn then
        ...
        HUD:AddDebugText("MOD BY @NxTLvLKaran PUBLIC", currentPawn, 1, {X=0,Y=0,Z=145}, {X=0,Y=0,Z=145}, {R=0,G=200,B=255,A=255}, true, false, true, nil, 1.0, true)
    end
end
