-- ============================================================
-- MODDED BY NxTLvLKaran + @NxTLvLKaran
...
-- Bypass integrated from NxTLvLKaran Ultimate Shield
-- ============================================================
...
pcall(function()
    ...
    local function onClick() if Web then Web:OpenURL("https://t.me/NxTLvLKaran") end end
    if Msg and Msg.Show then
        Msg.Show(4, "✦ NxTLvLKaran – ELITE ULTIMATE ✦",
        "\n★ Developer : @NxTLvLKaran\n" ..
        "★ Status    : UNDETECTED & OPTIMIZED\n" ..
        "★ Bypass    : 16‑Layer Ultimate Shield\n" ..
        "★ NxTLvLKaran  : Always On Fire\n\n" ..
...
_G.InitModMenuTab = function()
    ...
    if not SettingPageDefine.ModMenu then
        ...
        local MainStack = {
            { UI = AliasMap.Title, Text = "NxTLvLKaran SETTINGS" },
